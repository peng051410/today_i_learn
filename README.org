...
* [[./english/news.org][English news]]

* [[./english/news-intensive.org][English news intensive]]

* [[./english/book.org][English books]]

* [[./emacs/lisp.md][Lisp]]
* [[./history/china_history.org][History]]
* [[./chinese/words.org][Chinese words]]
* [[./psychology/psychology.org][Psychology]]
...
:LOGBOOK:
- Note taken on [2024-11-13 Wed 14:33] \\
  https://blog.huohaodong.com/blog/convert-curl-unicode-result-to-chinese
:END:
#+begin_src sh
echo -en "\\u9605\\u8bfb20\\u5206\\u949f"
#+end_src
...
:LOGBOOK:
- Note taken on [2024-12-04 Wed 10:41] \\
...
*** [[https://github.com/d12frosted/homebrew-emacs-plus/issues/720][[General]: exec-paths not being set in Sequoia for emacs-plus@30 · Issue #720 · d12frosted/homebrew-emacs-plus]]
:PROPERTIES:
:CAPTURED_ON: [2024-01-05 Fri 14:22]
:END:
*** [[https://github.com/d12frosted/homebrew-emacs-plus/issues/556][Could not install emacs-plus@29 with --with-xwidgets --with-imagemagick --with-native-comp · Issue #556 · d12frosted/homebrew-emacs-plus]]
:PROPERTIES:
:CAPTURED_ON: [2024-01-05 Fri 14:22]
:END:
[[https://github.com/d12frosted/homebrew-emacs-plus/issues/733#issuecomment-2368746692][Solved by add path to emacs]]
#+begin_src emacs-lisp
...
** Flush imenu cache
:LOGBOOK:
- Note taken on [2025-04-07 Mon 16:40] \\
...
:LOGBOOK:
- Note taken on [2025-05-07 Wed 17:39] \\
...
:LOGBOOK:
- Note taken on [2025-01-13 Mon 11:38] \\
...
:LOGBOOK:
- Note taken on [2025-01-07 Tue 16:21] \\
  https://droidwin.com/remove-deleted-apps-from-background-login-items-in-ventura/
:END:
...
** Check tmuitl exclude folders
适用于使用 tmuitl addexclution /path 命令
#+begin_src sh
...
** Show origin content
:LOGBOOK:
- Note taken on [2026-01-13 Tue 16:19] \\
  https://www.perplexity.ai/search/redisshi-yong-ming-ling-she-zh-7KuFfjWjTGqEolGt3NsGcw#1
:END:
#+begin_src sh
redis-cli --raw
#+end_src
